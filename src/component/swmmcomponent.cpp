...
SWMMComponent::SWMMComponent(const QString &id, SWMMComponent *component)
   :AbstractModelComponent(id,component),
     ...
     m_currentProgress(0)
{
   m_startDateTime = new Temporal::Time(this);
   m_endDateTime = new Temporal::Time(this);
   m_currentDateTime = new Temporal::Time(this);
   createArguments();
}
...
Temporal::Time* SWMMComponent::startDateTime() const
{
   return m_startDateTime;
}

Temporal::Time* SWMMComponent::endDateTime() const
{
   return m_endDateTime;
}

Temporal::Time* SWMMComponent::currentDateTime() const
{
...
void SWMMComponent::updateInputExchangeItems()
{
   ...
   {
      HydroCouple::IInput* tinput = dynamic_cast<HydroCouple::IInput*>(input);
