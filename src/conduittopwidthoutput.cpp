/*!
 * \file   conduittopwidthoutput.cpp
...
ConduitTopWidthOutput::ConduitTopWidthOutput(const QString &id,
...
ConduitTopWidthOutput::~ConduitTopWidthOutput()
{

}

void ConduitTopWidthOutput::updateValues(IInput *querySpecifier)
{
...
void ConduitTopWidthOutput::updateValues()
{
  moveDataToPrevTime();
