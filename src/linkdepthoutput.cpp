...
LinkDepthOutput::LinkDepthOutput(const QString &id,
...
LinkDepthOutput::~LinkDepthOutput()
{

}

void LinkDepthOutput::updateValues(IInput *querySpecifier)
{
...
void LinkDepthOutput::updateValues()
{
  moveDataToPrevTime();
