/*!
 * \file   conduitxsectareaoutput.cpp
...
ConduitXSectAreaOutput::ConduitXSectAreaOutput(const QString &id,
...
ConduitXSectAreaOutput::~ConduitXSectAreaOutput()
{

}

void ConduitXSectAreaOutput::updateValues(IInput *querySpecifier)
{
...
void ConduitXSectAreaOutput::updateValues()
{
  moveDataToPrevTime();
