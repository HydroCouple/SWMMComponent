...
#ifndef LINKDEPTHOUTPUT_H
#define LINKDEPTHOUTPUT_H
...
class SWMMCOMPONENT_EXPORT LinkDepthOutput: public TimeGeometryOutputDouble
{
    Q_OBJECT

  public:

    LinkDepthOutput(const QString &id,
                   Dimension *timeDimension,
                   Dimension *geometryDimension,
                   ValueDefinition *valueDefinition,
                   SWMMComponent *modelComponent);

    virtual ~LinkDepthOutput();
